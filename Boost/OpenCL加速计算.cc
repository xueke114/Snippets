...
// 编译指令(For Windows)
// cl OpenCL加速计算.cc  -o helloOpenCL /EHsc /I C:\OSGeo4W\include\boost-1_74 /I C:\OSGeo4W\include /MD /link /libpath:C:\OSGeo4W\lib\ libhdf5.lib libhdf5_cpp.lib opencl.lib szip.lib zlib.lib
